//
//  JXCategoryTitleImageNumberView.h
//  JXCategoryView
//
...
@interface JXCategoryTitleImageNumberView : JXCategoryTitleImageView
 ...
 */
@property (nonatomic, copy) NSString *(^ __nullable numberStringFormatterBlock)(NSInteger number);
